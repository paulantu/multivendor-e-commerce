<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#role_permission" aria-expanded="false" aria-controls="error">
            ...
            <div class="collapse" id="role_permission">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ url('admin/all-roles') }}"> Role </a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{ url('admin/all-permissions') }}"> Permissions </a>
                    </li>
                </ul>
            </div>
        </li>
